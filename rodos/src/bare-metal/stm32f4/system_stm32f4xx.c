...
#if BOOTIMAGE_PAGE==1
#define VECT_TAB_OFFSET  0x00004200 
#elif BOOTIMAGE_PAGE==2
#define VECT_TAB_OFFSET  0x00008200
#elif BOOTIMAGE_PAGE==3
#define VECT_TAB_OFFSET  0x0000C200
#elif BOOTIMAGE_PAGE==4
#define VECT_TAB_OFFSET  0x00010200
#elif BOOTIMAGE_PAGE==5
#define VECT_TAB_OFFSET  0x00020200
#elif BOOTIMAGE_PAGE==6
#define VECT_TAB_OFFSET  0x00040200
#elif BOOTIMAGE_PAGE==7
#define VECT_TAB_OFFSET  0x00060200
#elif BOOTIMAGE_PAGE==8
#define VECT_TAB_OFFSET  0x00080200
#elif BOOTIMAGE_PAGE==9
#define VECT_TAB_OFFSET  0x000A0200
#elif BOOTIMAGE_PAGE==10
#define VECT_TAB_OFFSET  0x000C0200
#elif BOOTIMAGE_PAGE==11
#define VECT_TAB_OFFSET  0x000E0200
#else
#define VECT_TAB_OFFSET  0x00000000 /*!< Vector Table base offset field. 

...
bglib_temp_msg.header=(((uint32)wifi_msg_type_cmd|wifi_dev_type_wifi|(((uint32)1+bglib_temp_msg.cmd_util_atoi.string.len)>>8)))|((((uint32)1+bglib_temp_msg.cmd_util_atoi.string.len)&0xff)<<8)|((uint32)0xc<<16)|((uint32)0x0<<24);\
